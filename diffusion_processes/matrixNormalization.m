function aff_matrix = matrixNormalization(distance_matrix, kth)
% Same as ICG_MatrixNormalization, but not using efficient minmaxk library 
% for improved compatility.
...
%   ****************************************************************
    ...
    vals = minmaxk_sort(distance_matrix, kth, 'max', 2);
    sigmas_i = vals(:, kth);
    W = sigmas_i*sigmas_i';
